void hexdump(const char *s); // hexdump string contents
void hexdumpb( const void *ptr, unsigned len ); // hexdump mem contents
void hexdumpf( FILE *fp, const void *ptr, unsigned len, int width ); // hexdump mem contents to file, with specific column-width
...
void hexdumpb( const void *ptr, unsigned len ) {
