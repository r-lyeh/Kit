const char *strstri(const char *text, const char *sub); // finds substring in text. case insensitive. returns NULL if not found
const char *strbegi(const char *text, const char *sub); // finds substring at beginning of text. case insensitive. returns NULL if not found
const char *strendi(const char *text, const char *sub); // finds substring at end of text. case insensitive. returns NULL if not found

const char *strrstr(const char *text, const char *sub); // last occurence of substring in text. similar to strrchr(). returns NULL if not found
const char *strrstri(const char *text,const char *sub); // last occurence of substring in text. similar to strrchr(). case insensitive. returns NULL if not found
