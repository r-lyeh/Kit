...
# [K·I·T {{VERSION}}](https://github.com/r-lyeh/kit)
## a b o u t

- https://github.com/r-lyeh/kit is a 2D+3D game framework in C.
- Download latest release: https://github.com/r-lyeh/kit/releases
- WIP Documentation below. Need extra support? <a href="https://discord.gg/yyjCkUQKPV">Join us</a>.

![Image from hello.c](https://i.imgur.com/WMNO8J1.png)
